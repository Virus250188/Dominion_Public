...
export default async function LoginPage() {
  ...
  return (
    <>
      {/* Custom login background — covers animated BG */}
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/3 right-1/4 h-[200px] w-[300px] rounded-full bg-[#6366f1]/5 blur-[80px]" />
      </div>

      <div className="relative z-10 flex min-h-screen items-center justify-center p-4">
        <div className="flex flex-col items-center">
          <LoginHero mode="login" />

          {/* Glass login card */}
          <div className="w-full max-w-sm">
            <div className="glass-card overflow-hidden">
              <div className="px-8 py-8">
                <p className="mb-6 text-center text-sm text-muted-foreground">Willkommen zurueck</p>
                <LoginForm />
              </div>
            </div>
          </div>
